...
class LdrOutdoorNode:
    ...
    def __init__(self, ipAddress, interval):
        ...
        self.mqtt_sub =  mqtt.Client("Backdoor LdrOutdoor messages")
        ...
        self.mqtt_sub.subscribe("/backdoor/U38/0/1/LdrOutdoor/#", qos=2)

        self.mqtt_pub = mqtt.Client("Outdoor light publisher")
    ...
    def start(self):
        ...
        ts = LdrOutdoorSensor(20,30,0,1000)
    ...
    def on_backdoor_connect(self, client, userdata, message):
        print("LdrOutdoorNode :: Backdoor connect")
...
#LdrOutdoorNode("192.168.0.177", 5).start()
